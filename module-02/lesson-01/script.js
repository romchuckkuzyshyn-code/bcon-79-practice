...
function f3() {
  if (+input3_1.value > +input3_2.value) {
    out3.textContent = +input3_1.value;
  } else {
    out3.textContent = +input3_2.value;
  }
}
...
function f7() {
  const resolt = input71.value ** input72.value;
  out7.textContent = resolt;
}
...
const input120 = document.querySelector(".i-120");
...
const input130 = document.querySelector(".i-130");
...
function f13() {
  const value = input120.value;
  out13.textContent = typeof value;
}
...
function f14() {
  const a14 = +input141.value;
  const b14 = +input142.value;
  const resolt = select143.value;

  if (resolt === "+") {
    out14.textContent = a14 + b14;
  } else if (resolt === "-") {
    out14.textContent = a14 - b14;
  } else if (resolt === "*") {
    out14.textContent = a14 * b14;
...
function f15() {
  const a15 = +select151.value;
  const b15 = +select152.value;
  const c15 = select153.value;
  if (a15 === 1 && b15 === 1 && c15 === "&&") {
    out15.textContent = 1;
  } else if (a15 === 0 && b15 === 1 && c15 === "&&") {
    out15.textContent = 0;
  } else if (a15 === 1 && b15 === 0 && c15 === "&&") {
    out15.textContent = 0;
  } else if (a15 === 0 && b15 === 0 && c15 === "&&") {
    out15.textContent = 0;
  } else if (a15 === 1 && b15 === 1 && c15 === "||") {
    out15.textContent = 1;
  } else if (a15 === 0 && b15 === 1 && c15 === "||") {
    out15.textContent = 1;
  } else if (a15 === 1 && b15 === 0 && c15 === "||") {
